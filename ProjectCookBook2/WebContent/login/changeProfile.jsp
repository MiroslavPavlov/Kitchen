...
<html>
	...
	<style>
	body{
	background:url(https://wallpaperscraft.com/image/spices_seasonings_red_pepper_black_pepper_pepper_star_anise_onion_ginger_garlic_walnuts_bay_leaf_78738_3840x2400.jpg)  no-repeat center fixed;
					...
					<div  class="wrap">
						  <div class="Regisration">
						  	<div class="Regisration-head">
						    	<h2><span></span>Change Profile</h2>
						 	 </div>
						  	<form method="post" action="${pageContext.request.contextPath}/ProfileServlet">
						  	<div style="color: #FF0000;">${usernameError}${emptyFieldError}${passConnfirmation }</div>
						  		...
						  		<input type="hidden" value="User Name" name="username" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'User Name';}" >
